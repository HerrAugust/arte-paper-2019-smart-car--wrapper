...
#define RIGHT1              8 /* right motor can go forward or backwards */
#define SPEEDPINRIGHT       9 /* right motor can have different speeds, from 0 to 255 */
#define RIGHT2              11
#define LEFT1               12
...
void setSpeed(int speed_left, int speed_right) {
    speedmotorLeft = speed_left;
    speedmotorRight = speed_right;
}
...
void leftMotor(int direction){
    if(direction == FORWARD) {
        ...
        // togliendo questa istr il bt funziona
